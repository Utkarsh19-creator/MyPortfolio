  ...
  head: () => ({
    meta: [
      ...
      { title: "Utkarsh Srivastava — Full-Stack Developer" },
      {
        name: "description",
        content:
          "Full-stack developer from Lucknow building Spring Boot APIs, React interfaces and cloud deploys.",
      },
      ...
      { property: "og:title", content: "Utkarsh Srivastava — Full-Stack Developer" },
      {
        ...
        content:
          "Spring Boot APIs, React frontends and clean data models — selected work and contact.",
      },
